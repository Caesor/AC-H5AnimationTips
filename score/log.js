 ...
 */
 ...
 var init = function(opt) {
     option.logExtJs = opt.logExtJs || option.logExtJs;
     option.logExtCss = opt.logExtCss || option.logExtCss;
     option.triggerLog = triggerLog;
